...
public class SessionTrackerImpl extends Thread implements SessionTracker {
            ...
            long sid)
    {
        ...
        this.expirer = expirer;//Zookeeper server
    ...
    /**
     * client 发送ping消息，提示server检查session，进而保证自己不超期.
     * 判断会话 是否超期
     */
    synchronized public boolean touchSession(long sessionId, int timeout) {
        ...
        long expireTime = roundToInterval(System.currentTimeMillis() + timeout); //one tick
    ...
    synchronized public int UpdateSession(long sessionId, int timeout){
